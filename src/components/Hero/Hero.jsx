    ...
    <section className="hero-section">
      ...
      >
        ...
        <p className="hero-subtitle">
          Generate production-grade custom role configurations, practice voice
          or text response cycles, and receive real-time granular architectural
          weakness metrics instantly.
        </p>
        <div className="hero-actions">
          <Link to="/setup" className="hero-btn-primary">
            Get Started Free
          </Link>
